...
addEffects(Items.AZALEA                , new StatusEffectInstance(DOLPHINS_GRACE     , 2000), new StatusEffectInstance(SATURATION         , 0));
...
addEffects(Items.CACTUS                , new StatusEffectInstance(SATURATION         , 0), new StatusEffectInstance(INVISIBILITY       , 1300));
...
addEffects(Items.LILY_PAD              , new StatusEffectInstance(FIRE_RESISTANCE    , 1000), new StatusEffectInstance(INSTANT_DAMAGE     , 0));
...
addEffects(Items.MOSS_BLOCK            , new StatusEffectInstance(INSTANT_HEALTH     , 0), new StatusEffectInstance(WITHER             , 1400));
...
addEffects(Items.SHORT_GRASS           , new StatusEffectInstance(HEALTH_BOOST       , 2000), new StatusEffectInstance(INSTANT_HEALTH     , 0));
...
addEffects(Items.APPLE                 , new StatusEffectInstance(SPEED       , 80), new StatusEffectInstance(REGENERATION       , 40));
addEffects(Items.BEETROOT              , new StatusEffectInstance(INSTANT_HEALTH     , 0), new StatusEffectInstance(ABSORPTION         , 40));
addEffects(Items.BEETROOT_SEEDS        , new StatusEffectInstance(OOZING             , 900) , new StatusEffectInstance(NIGHT_VISION       , 2100));
addEffects(Items.CARROT                , new StatusEffectInstance(NIGHT_VISION    , 100), new StatusEffectInstance(WATER_BREATHING            , 600));
addEffects(Items.CHORUS_FRUIT          , new StatusEffectInstance(STRENGTH           , 40), new StatusEffectInstance(LEVITATION         , 600));
addEffects(Items.COCOA_BEANS           , new StatusEffectInstance(SLOW_FALLING       , 2100), new StatusEffectInstance(HEALTH_BOOST       , 2100));
addEffects(Items.GLOW_BERRIES          , new StatusEffectInstance(NIGHT_VISION       , 100), new StatusEffectInstance(GLOWING           , 40));
addEffects(Items.MELON_SEEDS           , new StatusEffectInstance(REGENERATION       , 2300), new StatusEffectInstance(INVISIBILITY       , 1800));
addEffects(Items.MELON_SLICE           , new StatusEffectInstance(HEALTH_BOOST, 20), new StatusEffectInstance(SPEED             , 100));
addEffects(Items.PITCHER_POD           , new StatusEffectInstance(INFESTED           , 1000), new StatusEffectInstance(SLOW_FALLING       , 2000));
addEffects(Items.POISONOUS_POTATO      , new StatusEffectInstance(POISON             , 100), new StatusEffectInstance(NAUSEA             , 100));
addEffects(Items.POTATO                , new StatusEffectInstance(SLOW_FALLING         , 40), new StatusEffectInstance(INSTANT_HEALTH     , 0));
...
addEffects(Items.SWEET_BERRIES         , new StatusEffectInstance(WATER_BREATHING          , 100), new StatusEffectInstance(STRENGTH           , 40));
addEffects(Items.TORCHFLOWER_SEEDS     , new StatusEffectInstance(CONDUIT_POWER      , 2300), new StatusEffectInstance(SLOWNESS           , 2300));
addEffects(Items.WHEAT_SEEDS           , new StatusEffectInstance(MINING_FATIGUE     , 1700), new StatusEffectInstance(SATURATION         , 0));

addEffects(Items.DANDELION             , new StatusEffectInstance(SATURATION         , 0), new StatusEffectInstance(REGENERATION       , 2100));
addEffects(Items.BLUE_ORCHID           , new StatusEffectInstance(SATURATION         , 0), new StatusEffectInstance(NAUSEA             , 2100));
...
addEffects(Items.ALLIUM                , new StatusEffectInstance(SATURATION         , 0), new StatusEffectInstance(FIRE_RESISTANCE    , 1500));
...
addEffects(Items.DARK_OAK_SAPLING      , new StatusEffectInstance(DARKNESS           , 1300), new StatusEffectInstance(INSTANT_DAMAGE     , 0));
...
addEffects(Items.COD                   , new StatusEffectInstance(TRIAL_OMEN         , 40), new StatusEffectInstance(HASTE             , 100));
addEffects(Items.SALMON                , new StatusEffectInstance(DOLPHINS_GRACE     , 40), new StatusEffectInstance(JUMP_BOOST         , 40));
addEffects(Items.PUFFERFISH            , new StatusEffectInstance(POISON             , 400), new StatusEffectInstance(UNLUCK             , 100));
addEffects(Items.RABBIT                , new StatusEffectInstance(INFESTED           , 100), new StatusEffectInstance(WEAVING            , 100));
...
addEffects(Items.BEEF                  , new StatusEffectInstance(BLINDNESS          , 200), new StatusEffectInstance(HUNGER             , 400));
addEffects(Items.CHICKEN               , new StatusEffectInstance(MINING_FATIGUE     , 200), new StatusEffectInstance(HUNGER             , 400));
addEffects(Items.MUTTON                , new StatusEffectInstance(WEAKNESS           , 200), new StatusEffectInstance(HUNGER             , 400));
addEffects(Items.ROTTEN_FLESH          , new StatusEffectInstance(POISON             , 200) , new StatusEffectInstance(HUNGER             , 800));
addEffects(Items.SPIDER_EYE            , new StatusEffectInstance(NIGHT_VISION       , 100), new StatusEffectInstance(POISON             , 100));
addEffects(Items.TROPICAL_FISH         , new StatusEffectInstance(JUMP_BOOST         , 40), new StatusEffectInstance(HEALTH_BOOST       , 40));
...
addEffects(Items.GLISTERING_MELON_SLICE, new StatusEffectInstance(INSTANT_HEALTH     , 0), new StatusEffectInstance(REGENERATION       , 40));
...
addEffects(Items.BROWN_MUSHROOM        , new StatusEffectInstance(POISON             , 2500), new StatusEffectInstance(SATURATION         , 0));
addEffects(Items.RED_MUSHROOM          , new StatusEffectInstance(WITHER             , 1600), new StatusEffectInstance(SATURATION         , 0));
...
addEffects(Items.WARPED_ROOTS          , new StatusEffectInstance(INSTANT_DAMAGE     , 0), new StatusEffectInstance(GLOWING            , 1100));
...
addEffects(Items.NETHER_WART           , new StatusEffectInstance(INSTANT_HEALTH     , 0), new StatusEffectInstance(NAUSEA             , 1800));
    }
