...
class Translation extends FabricLanguageProvider {

    protected Translation(FabricDataOutput dataGenerator, CompletableFuture<RegistryWrapper.WrapperLookup> registries) {
